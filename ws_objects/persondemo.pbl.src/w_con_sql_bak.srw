$PBExportHeader$w_con_sql_bak.srw
forward
global type w_con_sql_bak from window
end type
type wb_new from webbrowser within w_con_sql_bak
end type
type dw_new from vs_dw_api within w_con_sql_bak
end type
type st_4 from statictext within w_con_sql_bak
end type
type st_3 from statictext within w_con_sql_bak
end type
type dw_columns from vs_dw_api within w_con_sql_bak
end type
type dw_tables from vs_dw_api within w_con_sql_bak
end type
type cb_create from commandbutton within w_con_sql_bak
end type
type st_2 from statictext within w_con_sql_bak
end type
type st_1 from statictext within w_con_sql_bak
end type
type mle_1 from multilineedit within w_con_sql_bak
end type
type st_registros from statictext within w_con_sql_bak
end type
type cbx_1 from checkbox within w_con_sql_bak
end type
type st_tablerows from statictext within w_con_sql_bak
end type
type pb_disquete from picturebutton within w_con_sql_bak
end type
end forward
...
global w_con_sql_bak w_con_sql_bak
